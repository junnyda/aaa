...
public class QEvent extends EntityPathBase<Event> {
    ...
    public final com.bit.account.domain.entity.QAccount createdBy;
    ...
    public final com.bit.study.domain.entity.QStudy study;
    ...
    public QEvent(Class<? extends Event> type, PathMetadata metadata, PathInits inits) {
        ...
        this.createdBy = inits.isInitialized("createdBy") ? new com.bit.account.domain.entity.QAccount(forProperty("createdBy"), inits.get("createdBy")) : null;
        this.study = inits.isInitialized("study") ? new com.bit.study.domain.entity.QStudy(forProperty("study")) : null;
    }
