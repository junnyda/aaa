package com.bit.account.domain.entity;
...
import com.bit.bookclub.modules.account.domain.entity.PersistentLogins;
...
public class QPersistentLogins extends EntityPathBase<PersistentLogins> {
    ...
    private static final long serialVersionUID = -319771001L;
